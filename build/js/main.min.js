...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    // sliderCoaches();
    Object(_vendor_js__WEBPACK_IMPORTED_MODULE_2__["coachesSlider"])();
    Object(_vendor_js__WEBPACK_IMPORTED_MODULE_2__["reviewCarousel"])();
    findVideos();
    moveToBlock();
  });
});
...
var moveToBlock = function moveToBlock() {
  var button = document.querySelector('.intro__wrapper > a');
  var block = document.querySelector('.membership');
...
// Tabs
var triggers = document.querySelectorAll('.tabs__item');
var tabsItems = document.querySelectorAll('.tabs__block');
triggers.forEach(onTabClick);
function onTabClick(item) {
  item.addEventListener('click', function (event) {
    event.preventDefault();
    var currentTrigger = item;
    var tabId = currentTrigger.getAttribute('data-tab');
    var currentTab = document.querySelector(tabId);
    if (!currentTrigger.classList.contains('tabs__item--active')) {
      triggers.forEach(function (child) {
        return child.classList.remove('tabs__item--active');
      });
      tabsItems.forEach(function (child) {
        return child.classList.remove('tabs__block--active');
      });
...
function parseMediaURL() {
  var regexp = /https:\/\/(?:youtu\.be\/|(?:[a-z]{2,3}\.)?youtube\.com\/watch(?:\?|#\!)v=)([\w-]{11}).*/gi;
  var match = regexp.exec(document.querySelector('.video__link').href)[1];
  return match;
}
...
/*!**********************!*\
  !*** ./js/vendor.js ***!
  \**********************/
/*! exports provided: coachesSlider, reviewCarousel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "coachesSlider", function() { return coachesSlider; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "reviewCarousel", function() { return reviewCarousel; });
